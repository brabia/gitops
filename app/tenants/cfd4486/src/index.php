<?php
$tenantId  = 'cfd4486';
$namespace = 'linexa-tenant-cfd4486';
...
try {
    ...
    if ((int)$db->query('SELECT COUNT(*) FROM users')->fetchColumn() === 0) {
        $db->exec("INSERT INTO users (name, email) VALUES
            ('Alice',   'alice@tenant-cfd4486.linexa.eu'),
            ('Bob',     'bob@tenant-cfd4486.linexa.eu')");
    }
...
<div class="wrap">
  ...
  <div class="header">
    ...
    <p class="meta"><?= $now->format('Y-m-d H:i:s') ?> UTC &nbsp;·&nbsp; own pod &nbsp;·&nbsp; own namespace &nbsp;·&nbsp; own MySQL &nbsp;·&nbsp; <span style="color:#a78bfa"><?= htmlspecialchars(getenv('IMAGE_TAG') ?: 'dev') ?></span></p>
  </div>
