...
try {
    $db = new PDO(
        'mysql:host=mysql.linexa-tenant-3622fab.svc.cluster.local;port=3306;dbname=linexa;connect_timeout=10',
        'linexa', 'linexapass',
...
<div class="wrap">
  ...
  <div class="header">
    ...
    <p class="meta"><?= $now->format('Y-m-d H:i:s') ?> UTC &nbsp;·&nbsp; own pod &nbsp;·&nbsp; own namespace &nbsp;·&nbsp; own MySQL &nbsp;·&nbsp; <span style="color:#34d399"><?= htmlspecialchars(getenv('IMAGE_TAG') ?: 'dev') ?></span></p>
  </div>
